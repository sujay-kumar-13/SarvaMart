...
import com.sujay.apps.sarvamart.databinding.FragmentLoginBinding;
...
//        }
        ...
        binding.back.setOnClickListener(click -> requireActivity().getOnBackPressedDispatcher().onBackPressed());
...
//                binding.newUserSignUp.setVisibility(View.GONE);
                ...
                binding.backToSignIn.setVisibility(View.VISIBLE);
                ...
                binding.backToSignIn.performClick();
            }
        });
...
//            binding.newUserSignUp.setVisibility(View.VISIBLE);
            ...
            binding.backToSignIn.setVisibility(View.GONE);
